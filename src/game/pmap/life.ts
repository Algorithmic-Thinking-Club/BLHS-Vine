/* THE LIFE CONTRACT, shared with MAPVIS.
 *
 * Copied verbatim from MAPVIS-next/src/core/life.ts. Both sides must evaluate a
 * behaviour identically or the editor preview lies about the game, so this file
 * is a copy on purpose rather than a re-implementation. If one changes, copy it
 * again; do not edit one side only.
 */
